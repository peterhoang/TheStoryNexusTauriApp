...
export function PromptForm({ prompt, onSave, onCancel }: PromptFormProps) {
    ...
    const [topP, setTopP] = useState(
        prompt?.top_p !== undefined ? prompt.top_p : 1.0
    );
    const [topK, setTopK] = useState(
        prompt?.top_k !== undefined ? prompt.top_k : 50
    );
    const [repetitionPenalty, setRepetitionPenalty] = useState(
        prompt?.repetition_penalty !== undefined
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div className='flex-1 flex items-center gap-2'>
                            ...
                            <Input
                                type='text'
                                value={
                                    topP === 0 ? 'Disabled' : topP.toFixed(2)
                                }
                                onChange={(e) => {
                                    if (e.target.value === '') {
                                        return;
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div className='flex-1 flex items-center gap-2'>
                            ...
                            <Input
                                type='text'
                                value={
                                    minP === 0 ? 'Disabled' : minP.toFixed(2)
                                }
                                onChange={(e) => {
                                    if (e.target.value === '') {
                                        return;
